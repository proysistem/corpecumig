    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Status (Activo=On/Off')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Usuario Staff (On/Off)')),
